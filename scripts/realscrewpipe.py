...
fa.goto_pose_with_cartesian_control(insert_position, cartesian_impedances=[3000, 3000, 100, 300, 300, 300]) #one of these but with impedance control? compliance comes from the matrix so I think that's good enough
